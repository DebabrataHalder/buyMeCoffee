...
const App = () => {
  ...
  const contractAddress = "0x5731aECb10De0a6c20B6De66c0b3194ADD53a4C6";
    ...
    <div >
      ...
      <div >
          <main  >
            ...
            {currentAccount ? (
              <div >
                <form className=" flex h-96 mt-16">
                  ...
                  <div className='className=" w-6/12 '>
                      ...
                      <div className=" w-10/12 relative flex h-48  flex-row-reverse overflow-clip rounded-lg">
                          ...
                          required
                          className="peer bg-white w-full rounded-r-lg border-4 px-2 text-slate-900 placeholder-slate-200 transition-colors duration-300 focus:border-sky-400 focus:outline-none focus:bg-white text-2xl bg-opacity-30" type="text" name="message"  >
                            </textarea>
                          <label className="bg-opacity-70 w-9/12 text-black font-bold text-xl pl-8 h-20  leading-3 flex items-center rounded-l-lg border border-slate-400 bg-slate-50 px-2  transition-colors duration-300 peer-focus:border-sky-400 peer-focus:bg-sky-400 peer-focus:text-white" for="message">Send Debabrata a message</label>
                      </div>
                  </div>
     


                  <div className='w-1/2  -ml-40 flex flex-col justify-start items-center '>
                    <button type="button" className="pl-16 w-4/6 h-16 text-3xl hover:text-red-600 hover:bg-yellow-400  bg-black text-white   focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg  px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 mr-2 mb-2" onClick=
                    { buySmallCoffee}>
          ...
          <div>
            <div className=' w-6/12 flex justify-center items-center'>
              {currentAccount && (<h1 className=" mt- w-80 text-3xl font-bold rounded-full  pl-10 p-5 bg-sky-500 text-gray-300" >Memos received</h1>)}
            </div>
              {currentAccount && (memos.map((memo, i) => {
                return (
                  <div key={i} className="m-7  text-3xl font-bold rounded-full  pl-10 p-5 bg-sky-500 text-gray-300 w-1/2 bg-opacity-20">
